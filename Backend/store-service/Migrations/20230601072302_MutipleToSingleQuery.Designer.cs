...
namespace App.Migrations
{
      ...
      [Migration("20230601072302_MutipleToSingleQuery")]
      partial class MutipleToSingleQuery
      {
            /// <inheritdoc />
...
#pragma warning disable 612, 618
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.CartItem", b =>
                      {
                            b.Property<int>("Id")
                          .ValueGeneratedOnAdd()
                          .HasColumnType("integer");
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.Models.Identity.Address", b =>
                      {
                            b.Property<int>("Id")
                          .ValueGeneratedOnAdd()
                          .HasColumnType("integer");
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.Models.ProductModel.Cart", b =>
                      {
                            b.Property<int>("Id")
                          .ValueGeneratedOnAdd()
                          .HasColumnType("integer");
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.Models.ProductModel.ProductCategory", b =>
                      {
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.CartItem", b =>
                      {
                            b.HasOne("gearshop_dotnetapp.Models.ProductModel.Cart", null)
                          .WithMany("Items")
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.Models.OrderModel.Order", b =>
                      {
                            b.HasOne("gearshop_dotnetapp.Models.Identity.Address", "Address")
                          .WithMany()
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.Models.ProductModel.Cart", b =>
                      {
                            b.HasOne("gearshop_dotnetapp.Models.Identity.User", "User")
                          .WithOne("Cart")
                          .HasForeignKey("gearshop_dotnetapp.Models.ProductModel.Cart", "UserId")
                          .OnDelete(DeleteBehavior.Cascade)
                          .IsRequired();
                  ...
                  modelBuilder.Entity("gearshop_dotnetapp.Models.ProductModel.Category", b =>
                      {
                            b.HasOne("gearshop_dotnetapp.Models.ProductModel.Category", "ParentCategory")
